...
timeofday = input(:,3); %time of day only
time = time'; %time in hours for dataset
deltaTime = 1; % time increment IN HOURS

%BESS variables
energyCapBESS = 240; % MWh maximum capacity
initialEnergyBESS = 80; % MWh initial capacity
chargePowerCap = 60; %MW BESS charge Power Cap
dischargePowerCap = 60; %MW BESS discharge Power Cap
...
arraySize = 60; % capacity of solar array in MW

%substation overload variables
npCapacity = 300; %MW - nameplate rating of the substation transformer
