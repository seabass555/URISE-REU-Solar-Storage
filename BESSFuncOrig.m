function [powerOutBESS,energyBESS,netLoadBESS] = BESSFuncOrig(time,deltaTime,netLoad,initialEnergyBESS,energyCapBESS,chargePowerCap,dischargePowerCap,chargeThreshold,dischargeThreshold)
