...
%BESS variables
energyCapBESS = 200; % MWh maximum capacity
initialEnergyBESS = 80; % MWh initial capacity
chargeThreshold = 130; % load in MW at when BESS will charge
dischargeThreshold = 180; % load in MW when BESS will discharge
chargePowerCap = 30; %MW BESS charge Power Cap
dischargePowerCap = 30; %MW BESS discharge Power Cap

arraySize = 80; % capacity of solar array in MW

%substation overload variables
npCapacity = 180; %MW - nameplate rating of the substation transformer
...
subplot(4,1,1);
hold on;
axis([4200 4500 -15 300]); %% parts of June and July only
% axis([0 8040 -15 130]);
